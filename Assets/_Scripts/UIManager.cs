...
public class UIManager : MonoBehaviour
{
    ...
    [HideInInspector]public Vector3 coinPngWorldPos;
    [Header("+ Paint Button + ")] 
    public Button paintButton;
    public List<TextMeshProUGUI> letters = new List<TextMeshProUGUI>();
    [HideInInspector]public Vector3 paintButtonWorldPos;
    [Header("+ Sew + ")] 
    ...
    private void ToPaintArea()
    {
        ...
        SoundManager.Instance.PlaySound("Whoosh1", 0.2f);
    }
    ...
    private void ToSewArea()
    {
        ...
        SoundManager.Instance.PlaySound("Whoosh2", 0.35f);
    }
}
